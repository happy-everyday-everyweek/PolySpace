# ruff: noqa: E501
TDD_METHODOLOGY = """# Test-Driven Development
...
2. **Return results, don't produce side effects** — prefer pure functions that return values
...
def execute(feature_description: str = "", interface_requirements: str = "") -> dict:
    return {
        "skill": "tdd",
        "methodology": TDD_METHODOLOGY,
        "feature": feature_description,
        "interface_requirements": interface_requirements,
        "instructions": (
            "Apply the TDD methodology. Use vertical slices (tracer bullets), "
            "not horizontal slicing. One test -> one implementation -> repeat. "
            "Follow the red-green-refactor loop strictly."
        ),
    }
