...
const groupedResults = computed((): ResultGroup[] => {
  ...
  const categoryOrder = ['memory', 'chat', 'knowledge', 'document', 'memo', 'todo', 'calendar', 'navigation', 'app', 'command', 'setting', 'action']
...
const categoryIcons: Record<string, string> = {
  ...
  memo: '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14,2 14,8 20,8"/></svg>',
